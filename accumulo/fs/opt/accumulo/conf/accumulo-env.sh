...
test -z "$ACCUMULO_TSERVER_OPTS" && export ACCUMULO_TSERVER_OPTS="${POLICY} -Xms2g -Xmx4g -XX:NewSize=1G -XX:MaxNewSize=1G"
test -z "$ACCUMULO_MASTER_OPTS"  && export ACCUMULO_MASTER_OPTS="${POLICY} -Xms2g -Xmx3g"
